...
# We need to chop off the red part of the spectrum as it isn't covered by the sMILES templates
t = t[:-1000]
...
sps.plot_age_metal(weights)
plt.pause(5)
plt.close()
sps.plot_age_alpha(weights)
plt.pause(5)
plt.close()
sps.plot_metal_alpha(weights)
plt.pause(5)
plt.close()

sps.mean_age_metal_alpha(weights)
